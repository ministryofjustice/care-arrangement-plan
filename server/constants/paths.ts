enum paths {
  ...
  HANDOVER_HOLIDAYS_WILL_CHANGE_DURING_SCHOOL_HOLIDAYS_NOT_REQUIRED = '/handover-and-holidays/will-change-during-school-holidays/not-required',
  HANDOVER_HOLIDAYS_HOW_CHANGE_DURING_SCHOOL_HOLIDAYS = '/handover-and-holidays/how-change-during-school-holidays',
  HANDOVER_HOLIDAYS_HOW_CHANGE_DURING_SCHOOL_HOLIDAYS_NOT_REQUIRED = '/handover-and-holidays/how-change-during-school-holidays/not-required',
  ...
  DECISION_MAKING_PLAN_LONG_TERM_NOTICE = '/decision-making/plan-long-term-notice',
